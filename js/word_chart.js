let corona_words = ["arbeit", "corona", "einkaufen", "gesund", "hochschule", "online", "sport", "treffen", "virus", "zuhause"];
...
function generate_comparison_word_chart() {
  // delete old charts
  $(".wordcloud").remove();
